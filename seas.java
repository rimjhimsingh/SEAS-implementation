...
public class seas{
    ...
    static String[] sbox = {"1001", "0100", "1010", "1011", "1101", "0001", "1000", "0101", "0110", "0010", "0000", "0011", "1100", "1110","1111", "0111"};
    
    //Inverse S-Box for inverse nibble substitution
    static String[] sbox_inverse = {"1010", "0101", "1001", "1011", "0001", "0111", "1000", "1111", "0110", "0000", "0010", "0011", "1100","0100", "1101", "1110"};
    ...
    public static void encrypt(String plaintext) //encrypt function
    {
        ...
        System.out.println(cipher_text); //this is the final ciphertext 
    }
